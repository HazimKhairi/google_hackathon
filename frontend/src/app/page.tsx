...
export default function HomePage() {
  ...
  const [view, setView] = useState<'main' | 'join' | 'create' | 'about'>('main');
  ...
  return (
    <main className="relative min-h-screen w-full bg-[#051C22] flex flex-col items-center justify-center overflow-hidden font-serif">
      ...
      <div className="relative z-20 flex flex-col items-center justify-center w-full min-h-[600px] px-8">
        ...
        <AnimatePresence mode="wait">
          {view === 'about' ? (
            ...
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="w-full max-w-lg flex flex-col items-center gap-16"
            >
              {/* GAME TITLE */}
              <motion.div
                ...
                <AnimatePresence mode="wait">
                  ...
                  {view === 'main' && (
                    ...
                    >
                      ...
                      <GameButton onClick={() => setView('about')}>About Game</GameButton>
                    </motion.div>
                  )}
